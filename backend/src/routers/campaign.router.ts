...
function createRouter(): Router {
    ...
    router.post('/:id/vouchers/batch', validator.run('voucher.createMany'), voucherController.createMany);
    router.get('/:id/vouchers', validator.run('voucher.list'), voucherController.list);
    router.get('/:id/vouchers/export', validator.run('voucher.export'), voucherController.export);
